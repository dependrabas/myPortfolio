...
$(function() {
  ...
  $("#contact-form").submit(function(event) {
    ...
    var mailtoLink = `mailto:dependrabas@gmail.com?subject=${encodeURIComponent(name)} - ${encodeURIComponent(company)}&body=Phone number : ${encodeURIComponent(phone)}%0A%0A${encodeURIComponent(message)}`;
